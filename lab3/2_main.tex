...
\subsection{Существование и единственность решения CARE}
Для бесконечного горизонта и \(Q\succeq 0,\ r>0\) симметричное \(P\succ0\) — единственное стабилизирующее решение CARE, если пара \((A,b)\) стабилизируема, а \((Q^{1/2},A)\) наблюдаема (детектируема). В этом случае матрица \(A-bK\) \emph{устойчива} и регулятор \(u=-Kx\) оптимален в классе линейных и нелинейных стратегий.
...
- \(P\succ0\) решает CARE и \(A-bK\) устойчиво;
